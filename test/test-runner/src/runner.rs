...
impl Runner {
    pub fn load<P1, P2, P3>(suites_path: P1, examples_path: P2, oopsla_examples_path: P3) -> Self
    where
        P1: AsRef<Path>,
        P2: AsRef<Path>,
        P3: AsRef<Path>,
    {
        ...
        suites
            .insert("oopsla_examples".to_owned(), Suite::new(oopsla_examples_path.as_ref().into()));
