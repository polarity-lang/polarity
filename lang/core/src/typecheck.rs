...
impl Infer for ust::Data {
    ...
    fn infer(&self, prg: &ust::Prg, ctx: &mut Ctx) -> Result<Self::Target, TypeError> {
        let ust::Data { info, name, ignored, typ, ctors } = self;
...
impl Infer for ust::Codata {
    ...
    fn infer(&self, prg: &ust::Prg, ctx: &mut Ctx) -> Result<Self::Target, TypeError> {
        let ust::Codata { info, name, ignored, typ, dtors } = self;
...
impl Infer for ust::Def {
    ...
    fn infer(&self, prg: &ust::Prg, ctx: &mut Ctx) -> Result<Self::Target, TypeError> {
        let ust::Def { info, name, ignored, params, self_param, ret_typ, body } = self;
...
impl Infer for ust::Codef {
    ...
    fn infer(&self, prg: &ust::Prg, ctx: &mut Ctx) -> Result<Self::Target, TypeError> {
        let ust::Codef { info, name, ignored, params, typ, body } = self;
